...
class Evaluator:
    ...
    def _compute_q_zCx(self, dataloader):
        """Compute the empirical distribution of q(z|x).
    ...
    def _estimate_latent_entropies(self, samples_zCx, params_zCX,
        ...
        using the empirical distribution of :math:`p(x)`.

        Note
        ----
        - the expectation over the empirical distribution is: :math:`q(z) = 1/N sum_{n=1}^N q(z|x_n)`.
