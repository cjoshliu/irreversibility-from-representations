...
# train models on experiments varying in wave-to-chaotic transition order parameter
# loop over datasets with twelve training seeds
declare -a SEEDS=("1234" "1243" "1324" "1342" "1423" "1432" "2134" "2143" "2314" "2341" "2413" "2431")
for dset in "$DATASET_DIR"/exp_orderp_vary/*
do
dset=${dset%*/}
...
mv results postprocessing/results/exp_orderp_vary
mkdir results